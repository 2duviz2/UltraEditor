...
public class AssetItem : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.T)) AssetsWindowManager.Instance.PreviewCamera.transform.position = new Vector3(0, -10000, 0);
    ...
    public void NewPreview(string path)
    {
        ...
        if (size > 5)
            previewObj.transform.Rotate(0, 180, 0);
        AssetsWindowManager.Instance.PreviewCamera.transform.position = new Vector3(0, -10000, 0);
