...
namespace UltraEditor.Classes
{
    public class EditorManager : MonoBehaviour
    {
        ...
        public SavableObjectData CreateAndPopulate(SavableObject obj, string Type = null) => new() 
        { 
            Id = GetIdOfObj(obj.gameObject),
            Name = obj.Name,
            ...
            Parent = obj.transform.parent != null ? GetIdOfObj(obj.transform.parent.gameObject) : "",
            Type = Type,
            Data = []
        };

        public void Save(string name, string description, string creator, string path, string thumbnailPath = null, string musicPath = null, string GUID = null)
        {
            ...
            // UltraEditor.Classes.EditorManager.testUnpack("newsavetesting.uterus", false);
